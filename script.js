...
const productList = [
    ...
    },
    {
        ...
        product_description: "Dantel, açıq rəng",
        product_price: 55,
        store_name: "Əliyev Moda Mərkəzi",
        store_address: "Bakı şəhəri, Azadlıq prospekti 89",
    },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayProducts() {
        const products = getProductListFromLocalStorage();
        ...
        products.forEach(product => {
            ...
            productDiv.innerHTML = `
                ...
                <p>Address: ${product.store_address}</p>
    ...
    function displayCart() {
        ...
        cart.forEach(product => {
            ...
            productDiv.innerHTML = `
                ...
                <p>Address: ${product.store_address}</p>
            `;
            cartListContainer.appendChild(productDiv);
        });
    }
